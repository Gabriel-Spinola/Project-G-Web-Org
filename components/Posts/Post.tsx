    ...
    <div className="postado mb-8">
      <div className='autor'>
        <div className='foto overflow-x-auto'>
          <Image
            className=''
            src="/test-img/img6279ecf669c820.03512746.jpg"
            alt="imgtest"
            width={48}
            height={48}
          />
      ...
      <div className='reacts w-[100%] h-[48px] mt-4 flex flex-row'>
        ...
        <div className='comment  flex flex-col justify-center items-center ml-8  hover:text-medium-primary w-[48px]'>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M9 22a1 1 0 0 1-1-1v-3H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6.1l-3.7 3.71c-.2.19-.45.29-.7.29H9m1-6v3.08L13.08 16H20V4H4v12h6Z" /></svg>
          <span>125</span>
        </div>
      </div>
