  ...
  return (
    <div className=' fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center z-20'>
      <div className='w-[809px] h-[192px] flex flex-col mt-[-20%] z-10'>
        <button className='text-pure-white text-xl place-self-end' onClick={onClose}>X</button>
          ...
          <form className='notClose'>
            ...
            <div className='notClose max-h-[64px] flex flex-row justify-between'>
              <div className='notClose'>
                <button className='notClose flex flex-row mt-8 select-none text-sm hover:text-medium-primary'>
                  ...
                  Envie um arquivo
                  <input type='file' accept='.pdf' multiple className='notClose'></input>
                </button>
              </div>
            </div>
          </form>
